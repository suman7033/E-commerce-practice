          ...
          <ul className="navbar-nav">
            ...
            <Link className='nav-link' to='/login'><b>LOGIN</b></Link>
              ...
              <Link className='nav-link' to='profile'>
               <img className='img1' src='https://png.pngtree.com/png-clipart/20200224/original/pngtree-avatar-icon-profile-icon-member-login-vector-isolated-png-image_5247852.jpg'/>
              </Link>&nbsp; &nbsp;
          </ul>
